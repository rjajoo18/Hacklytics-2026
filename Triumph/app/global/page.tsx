...
const COUNTRIES = [
  { code: "CN", name: "China", flag: "🇨🇳", rate: "145%", zoom: "4/35/105" },
  { code: "EU", name: "EU", flag: "🇪🇺", rate: "20%", zoom: "4/51/10" },
  { code: "MX", name: "Mexico", flag: "🇲🇽", rate: "25%", zoom: "4/24/-102" },
  { code: "CA", name: "Canada", flag: "🇨🇦", rate: "25%", zoom: "3/60/-96" },
  { code: "JP", name: "Japan", flag: "🇯🇵", rate: "24%", zoom: "5/36/138" },
  { code: "KR", name: "S. Korea", flag: "🇰🇷", rate: "26%", zoom: "6/36/128" },
  { code: "VN", name: "Vietnam", flag: "🇻🇳", rate: "46%", zoom: "5/16/108" },
  { code: "IN", name: "India", flag: "🇮🇳", rate: "26%", zoom: "4/21/79" },
  { code: "GB", name: "UK", flag: "🇬🇧", rate: "10%", zoom: "5/55/-3" },
  { code: "TW", name: "Taiwan", flag: "🇹🇼", rate: "32%", zoom: "7/24/121" },
  { code: "BR", name: "Brazil", flag: "🇧🇷", rate: "10%", zoom: "4/-10/-55" },
  { code: "AU", name: "Australia", flag: "🇦🇺", rate: "10%", zoom: "4/-25/134" },
  { code: "RU", name: "Russia", flag: "🇷🇺", rate: "35%", zoom: "3/62/90" },
  { code: "SA", name: "Saudi Arabia", flag: "🇸🇦", rate: "10%", zoom: "5/24/45" },
  { code: "ZA", name: "S. Africa", flag: "🇿🇦", rate: "30%", zoom: "5/-29/25" },
  { code: "TR", name: "Turkey", flag: "🇹🇷", rate: "10%", zoom: "6/39/35" },
  { code: "ID", name: "Indonesia", flag: "🇮🇩", rate: "32%", zoom: "5/-2/118" },
  { code: "TH", name: "Thailand", flag: "🇹🇭", rate: "36%", zoom: "6/13/101" },
  { code: "PH", name: "Philippines", flag: "🇵🇭", rate: "17%", zoom: "6/13/122" },
  { code: "MY", name: "Malaysia", flag: "🇲🇾", rate: "24%", zoom: "6/4/109" },
  { code: "SG", name: "Singapore", flag: "🇸🇬", rate: "10%", zoom: "8/1/104" },
  { code: "CH", name: "Switzerland", flag: "🇨🇭", rate: "31%", zoom: "7/47/8" },
  { code: "AR", name: "Argentina", flag: "🇦🇷", rate: "10%", zoom: "4/-34/-64" },
  { code: "NG", name: "Nigeria", flag: "🇳🇬", rate: "14%", zoom: "5/9/8" },
]
...
export default function Page() {
  ...
  // zoom 0.4 shows the full globe with space background visible
      ...
      <div className="flex h-screen w-full overflow-hidden">
        ...
        <SidebarInset className="flex flex-col flex-1 min-w-0 overflow-hidden">
          ...
          <div className="relative flex-1 overflow-hidden">
            ...
            {/* Country pill selector — scrollable top bar */}
            ...
            {/* Tariff rate card — only shown when country selected */}
            {selectedCountryData && (
              <div
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-red-400 leading-tight">{selectedCountryData.rate}</p>
                  <p className="text-[10px] text-white/30">US Tariff Rate</p>
                </div>
              </div>
            )}

            {/* Sector impact panel — only shown when country selected */}
            ...
            {/* Default hint — only when nothing selected */}
            {!mapCountry && (
              <div
